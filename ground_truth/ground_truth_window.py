...
class Ui_GroundTruthWidget(object):
    def setupUi(self, GroundTruthWidget):
        ...
        GroundTruthWidget.resize(993, 600)
        ...
        self.gridLayout.addWidget(self.nclass_label, 2, 0, 1, 1)
        ...
        self.pushButton_class_selection.setEnabled(False)
        ...
        self.gridLayout.addWidget(self.pushButton_class_selection, 0, 5, 1, 1)
        self.load_btn = QtWidgets.QPushButton(self.frame)
        self.load_btn.setObjectName("load_btn")
        self.gridLayout.addWidget(self.load_btn, 2, 4, 1, 1)
        ...
        self.comboBox_distance.addItem("")
        self.comboBox_distance.addItem("")
        self.gridLayout.addWidget(self.comboBox_distance, 0, 4, 1, 1)
        ...
        self.comboBox_pixel_selection_mode.addItem("")
        self.comboBox_pixel_selection_mode.addItem("")
        self.gridLayout.addWidget(self.comboBox_pixel_selection_mode, 0, 6, 1, 1)
        self.pushButton_manual = QtWidgets.QPushButton(self.frame)
        ...
        self.gridLayout.addWidget(self.run_btn, 2, 6, 1, 1)
        ...
        self.checkBox_seeGTspectra.setChecked(False)
    ...
    def retranslateUi(self, GroundTruthWidget):
        ...
        self.comboBox_ClassifMode.setItemText(2, _translate("GroundTruthWidget", "Semi-supervised"))
        ...
        self.comboBox_pixel_selection_mode.setItemText(0, _translate("GroundTruthWidget", "pixel"))
        self.comboBox_pixel_selection_mode.setItemText(1, _translate("GroundTruthWidget", "rectangle"))
        self.comboBox_pixel_selection_mode.setItemText(2, _translate("GroundTruthWidget", "ellipse"))
        self.pushButton_manual.setText(_translate("GroundTruthWidget", "Manual assign"))
